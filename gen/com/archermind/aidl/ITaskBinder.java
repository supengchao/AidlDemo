 ...
 * Original file: D:\\Anjoyo\\AndroidSpace\\AidlDemo\\src\\com\\archermind\\aidl\\ITaskBinder.aidl
 */
package com.archermind.aidl;
public interface ITaskBinder extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.archermind.aidl.ITaskBinder
{
 ...
 */
public static com.archermind.aidl.ITaskBinder asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
if ((0!=data.readInt())) {
_arg0 = com.archermind.aidl.Person.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
_arg0 = com.archermind.aidl.ITaskCallBack.Stub.asInterface(data.readStrongBinder());
...
@Override public java.lang.String fuc03(com.archermind.aidl.Person person) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public void registerCallBack(com.archermind.aidl.ITaskCallBack cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public java.lang.String fuc03(com.archermind.aidl.Person person) throws android.os.RemoteException;
public void registerCallBack(com.archermind.aidl.ITaskCallBack cb) throws android.os.RemoteException;
